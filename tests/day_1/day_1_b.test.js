...
const firstLocationVisitedTwice = require('../../src/day_1/firstLocationVisitedTwice')

describe('First Location Visited Twice', function() {
    it('Will return the first x,y coordinate that has been visited twice', function () {
      expect(firstLocationVisitedTwice('R8, R4, R4, R8')).to.equal(4);
    });
    ...
    it('Will return the answer to the problem', function() {
      ...
      expect(firstLocationVisitedTwice(input)).to.deep.equal(158);
    });
});